...
function P:to_sibling()
    ...
    local sibling_id = coroutine.yield(red.call.pane_index_down_to(parent_id, not is_left))
...
function P:to_child(is_left)
    local child_id = coroutine.yield(red.call.pane_index_down_to(self.id, is_left))
...
function P:v_split()
    ...
    self.id = coroutine.yield(red.call.pane_index_down_to(self.id, is_left))
end
